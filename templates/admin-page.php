...
<div class="wrap wp-data-bridge-admin">
    ...
    <div class="wp-data-bridge-header">
        <p class="description">
            <?php esc_html_e('Export and import posts, pages, custom post types, and users to/from CSV format.', 'wp-data-bridge'); ?>
        </p>
    </div>
    ...
    <div class="wp-data-bridge-help">
        ...
        <div class="help-section">
            ...
            <ul>
                <li><strong><?php esc_html_e('Posts & Pages:', 'wp-data-bridge'); ?></strong> <?php esc_html_e('Includes title, content, meta data, categories, and tags.', 'wp-data-bridge'); ?></li>
